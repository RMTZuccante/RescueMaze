...
uint16_t APDS9960::readAmbientLight() {
    return wireReadData16Bit(APDS9960_CDATAL);
}

uint16_t APDS9960::readRedLight() {
    return wireReadData16Bit(APDS9960_RDATAL);
}

uint16_t APDS9960::readGreenLight() {
    return wireReadData16Bit(APDS9960_GDATAL);
}

uint16_t APDS9960::readBlueLight() {
    return wireReadData16Bit(APDS9960_BDATAL);
}

uint8_t APDS9960::readProximity() {
    return wireReadData8Bit(APDS9960_PDATA);
}

uint8_t APDS9960::getProxIntLowThresh() {
    /* Read value from PILT register */
    return wireReadData8Bit(APDS9960_PILT);
}
...
uint8_t APDS9960::getProxIntHighThresh() {
    return wireReadData8Bit(APDS9960_PIHT);
}
...
uint8_t APDS9960::getLEDDrive() {
    ...
    return (wireReadData8Bit(APDS9960_CONTROL) >> 6) & 0b00000011;
}

void APDS9960::setLEDDrive(uint8_t drive) {
    uint8_t val = wireReadData8Bit(APDS9960_CONTROL);
...
uint8_t APDS9960::getProximityGain() {
    ...
    return (wireReadData8Bit(APDS9960_CONTROL) >> 2) & 0b00000011;
}
...
uint8_t APDS9960::getAmbientLightGain() {
    ...
    return wireReadData8Bit(APDS9960_CONTROL) & 0b00000011;
}
...
uint8_t APDS9960::getLEDBoost() {
    uint8_t val = wireReadData8Bit(APDS9960_CONFIG2);
...
uint8_t APDS9960::getProxGainCompEnable() {
    ...
    return (wireReadData8Bit(APDS9960_CONFIG3) >> 5) & 0b00000001;
}

void APDS9960::setProxGainCompEnable(uint8_t enable) {
    uint8_t val = wireReadData8Bit(APDS9960_CONFIG3);
    /* Set bits in register to given value */
    enable &= 0b00000001;
    enable = enable << 5;
    val &= 0b11011111;
...
uint8_t APDS9960::getProxPhotoMask() {
    ...
    return wireReadData8Bit(APDS9960_CONFIG3) & 0b00001111;;
}
...
uint16_t APDS9960::getLightIntLowThreshold() {
    return wireReadData16Bit(APDS9960_AILTL);
}
...
uint16_t APDS9960::getLightIntHighThreshold() {
    return wireReadData16Bit(APDS9960_AIHTL);
}
...
uint8_t APDS9960::getAmbientLightIntEnable() {
    ...
    return (wireReadData8Bit(APDS9960_ENABLE) >> 4) & 0b00000001;
}

void APDS9960::setAmbientLightIntEnable(uint8_t enable) {
    uint8_t val = wireReadData8Bit(APDS9960_ENABLE);
    /* Set bits in register to given value */
    enable &= 0b00000001;
    enable = enable << 4;
    val &= 0b11101111;
...
uint8_t APDS9960::getProximityIntEnable() {
    ...
    return (wireReadData8Bit(APDS9960_ENABLE) >> 5) & 0b00000001;
}

void APDS9960::setProximityIntEnable(uint8_t enable) {
    uint8_t val;
    val = wireReadData8Bit(APDS9960_ENABLE);
    /* Set bits in register to given value */
    enable &= 0b00000001;
    enable = enable << 5;
    val &= 0b11011111;
...
void APDS9960::clearAmbientLightInt() {
    wireReadData8Bit(APDS9960_AICLEAR);
}

void APDS9960::clearProximityInt() {
    wireReadData8Bit(APDS9960_PICLEAR);
}
