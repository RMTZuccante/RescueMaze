...
void Moviment::straight(bool invert){
  float now=orientation.yaw();
  motorFR.start(bound(speed + (direzione - now)*100, 65535), !invert);
  motorFL.start(bound(speed - (direzione - now)*100, 65535), !invert);
  motorRR.start(bound(speed + (direzione - now)*100, 65535), !invert);
  motorRL.start(bound(speed - (direzione - now)*100, 65535), !invert);
}
